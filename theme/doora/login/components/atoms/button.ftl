<#macro kw color="" component="button" size="" rest...>
  ...
  <#switch size>
    <#case "large">
      <#assign sizeClass="px-4 py-3 text-base">
      <#break>
    <#case "medium">
  ...
  <${component}
    class="${colorClass} ${sizeClass} flex justify-center relative rounded-xl w-full focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors"
